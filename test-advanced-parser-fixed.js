...
// Test the fixed advanced parser (reverted from llamaparse)
async function testAdvancedParserFixed() {
  console.log('🧪 Testing Fixed Advanced Parser...\n');
  ...
  try {
    ...
    console.log('\n🚀 Starting Fixed Advanced Parser...');
