...
// Test the updated llamaparse pipeline (without hardcoded API key)
async function testLlamaParseUpdated() {
  console.log('🧪 Testing Updated LlamaParse Pipeline...\n');
  ...
  try {
    ...
    console.log('\n🚀 Starting Updated LlamaParse Pipeline...');
    ...
    if (sendResponse && (sendResponse.text || sendResponse.result || sendResponse.data || sendResponse.documents)) {
      ...
      console.log('📋 Full response:', JSON.stringify(sendResponse, null, 2));
    }
